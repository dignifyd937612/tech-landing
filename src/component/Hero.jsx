      ...
      <div className="mx-auto flex min-h-[568px] max-w-[1650px] items-center px-6 pt-8 sm:px-8 lg:px-0 lg:pt-0">
        <div className="grid w-full grid-cols-1 items-center gap-8 lg:grid-cols-[720px_570px] lg:justify-center lg:gap-[30px]">
          <div className="mx-auto w-full text-center lg:mx-0 lg:text-left">
            <h1 className="font-poppins mx-auto max-w-[631px] text-[58px] leading-[63px] font-semibold tracking-normal text-white lg:mx-0">
              Looking for Software,{" "}
              <span className="text-[#009EFF]">Web and App Development?</span>
            </h1>

            <p className="mx-auto mt-7 max-w-[650px] text-[15px] leading-[1.55] text-white sm:text-[23.8px] lg:mx-0">
            ...
            <div className="mx-auto mt-7 flex w-full max-w-[650px] justify-center">
              {stats.map((stat, index) => (
                <div
                  key={stat.number}
                  className={`flex min-w-0 flex-1 flex-col items-center justify-start text-center ${
          ...
          <div className="relative w-full max-w-[570px] justify-self-center lg:justify-self-end">
            ...
            <div className="relative z-10 mx-auto w-full rounded-lg bg-[#07182A] px-8 py-9 sm:px-10 lg:mx-0 lg:h-[515px] lg:px-[48px] lg:py-10">
