      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-[1180px] px-6 py-20 sm:px-8 lg:px-10 lg:py-24">
          <div className="max-w-[850px]">
            <p className="mb-5 text-sm font-medium tracking-wide text-[#009EFF]">
              LEGAL
            </p>
            ...
            <p className="mt-6 max-w-[760px] text-[16px] leading-[1.7] text-white/65 sm:text-[18px]">
              Your privacy matters to us. This Privacy Policy explains how
              Dignifyd Tech Pvt Ltd. collects, uses, processes, and protects
        ...
        <div className="mx-auto max-w-[1180px] px-6 py-16 sm:px-8 lg:px-10 lg:py-20">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[240px_1fr] lg:gap-20">
            ...
            <article className="max-w-[820px]">
              <div className="mb-14">
                <p className="text-[15px] leading-[1.8] text-white/65 sm:text-[16px]">
                  This Privacy Notice for Dignifyd Tech Pvt Ltd. ("we," "us," or
              ...
              <section id="processing" className="mb-14 scroll-mt-24">
                ...
                <div className="mt-5 space-y-4 text-[15px] leading-[1.8] text-white/65 sm:text-[16px]">
                  ...
                  <p>
                    To request feedback. To send you marketing and promotional
                    communications. To deliver targeted advertising to you. To
                    determine the effectiveness of our marketing and promotional
                    campaigns. To save or protect an individual's vital
                    interest.
                  </p>
                </div>
              </section>
              ...
              <section id="cookies" className="mb-14 scroll-mt-24">
                ...
                <div className="mt-5 space-y-5 text-[15px] leading-[1.8] text-white/65 sm:text-[16px]">
                  ...
                  <p>
                    ...
                    advertisements or to tailor advertisements to your
                    interests. The third parties and service providers use their
                    technology to provide advertising about products and
              ...
              <section id="minors" className="mb-14 scroll-mt-24">
                ...
                <div className="mt-5 text-[15px] leading-[1.8] text-white/65 sm:text-[16px]">
                  ...
                  <p className="mt-5">
                    ...
                    18 years of age or the equivalent age as specified by law in
              ...
              <section id="privacy-rights" className="mb-14 scroll-mt-24">
                ...
                <div className="mt-5 text-[15px] leading-[1.8] text-white/65 sm:text-[16px]">
                  ...
                  <p className="mt-5">
                    If a decision that produces legal or similarly significant
              ...
              <section id="do-not-track" className="mb-14 scroll-mt-24">
                ...
                <div className="mt-5 text-[15px] leading-[1.8] text-white/65 sm:text-[16px]">
                  <p>
                    ...
                    DNT signals has been finalised.
                  </p>
              ...
              <section id="us-privacy-rights" className="mb-14 scroll-mt-24">
                ...
                <div className="mt-5 text-[15px] leading-[1.8] text-white/65 sm:text-[16px]">
                  <p>
                    ...
                    Oregon, Rhode Island, Tennessee, Texas, Utah, or Virginia,
                    you may have the right to request access to and receive
                    details about the personal information we maintain about you
                    and how we have processed it, correct inaccuracies, get a
...
function SectionNumber({ number }) {
  return (
    <div className="flex items-center gap-3">
      <span className="text-xs font-semibold tracking-wider text-[#009EFF]">
        {number}
      </span>
