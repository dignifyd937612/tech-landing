export const testimonials = [
  {
    ...
    company: "Trepp",
    logo: "/testimonials/trepp.png",
  },
  {
    id: 2,
    review:
      "Their expertise in front-end and backend development, rigorous QA testing, and effective DevOps support were remarkable. The team helped the client increase audience reach by 90%, visitor engagement by 70%, gross revenue by 75%, and conversion rate by 65%.",
    name: "Nitin Verma",
    designation: "CEO, InstaAstro\nTechno logies",
    company: "InstaAstro",
    logo: "/testimonials/instaastro.png",
  },
  {
    id: 3,
    review:
